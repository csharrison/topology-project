...
\setlength\parindent{12pt} % Removes all indentation from paragraphs - comment this line for an assignment with lots of text
...
\title{
\normalfont \normalsize
\textsc{Brown University} \\ [25pt] % Your university, school and/or department name(s)
\horrule{0.5pt} \\[0.4cm] % Thin top horizontal rule
\huge Decidabilility in Distributed Tasks \\ % The assignment title
\horrule{2pt} \\[0.5cm] % Thick bottom horizontal rule
}

\author{William Stephenson and Charles Harrison} % Your name
